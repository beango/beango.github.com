...
[![.Net垃圾回收机制原理（二）]({{ site.assetpath }}/2011-11/NET-GC-07.gif ".Net 垃圾回收机制原理（二）")]({{ site.assetpath }}/2011-11/NET-GC-07.gif ".Net 垃圾回收机制原理（二）")

图1 托管堆上的0代对象

现在如果堆上添加了更多的对象，堆填满时就会触发垃圾回收。当垃圾回收器分析托管堆时，会构建一个垃圾对象（图2中浅紫色块）和非垃圾对象的图。所有没有被回收的对象会被移动压缩到堆的最底端。这些没有被回收掉的对象就成为了1代对象，如图2所示

[![.Net垃圾回收机制原理（二）]({{ site.assetpath }}/2011-11/NET-GC-08.gif ".Net 垃圾回收机制原理（二）")]({{ site.assetpath }}/2011-11/NET-GC-08.gif ".Net 垃圾回收机制原理（二）")
...
[![.Net
垃圾回收机制原理（二）]({{ site.assetpath }}/2011-11/NET-GC-09.gif ".Net 垃圾回收机制原理（二）")]({{ site.assetpath }}/2011-11/NET-GC-09.gif ".Net 垃圾回收机制原理（二）")
...
[![.Net 垃圾回收机制原理（二）]({{ site.assetpath }}/2011-11/NET-GC-10.gif ".Net 垃圾回收机制原理（二）")]({{ site.assetpath }}/2011-11/NET-GC-10.gif ".Net 垃圾回收机制原理（二）")
