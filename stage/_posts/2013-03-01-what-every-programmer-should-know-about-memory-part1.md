...
[![每个程序员都应该了解的内存知识]({{ site.assetpath }}/2013-03/06104430_73iC.png "每个程序员都应该了解的内存知识")]({{ site.assetpath }}/2013-03/06104430_73iC.png "每个程序员都应该了解的内存知识")
...
[![每个程序员都应该了解的内存知识]({{ site.assetpath }}/2013-03/06104430_V9Tz.png "每个程序员都应该了解的内存知识")]({{ site.assetpath }}/2013-03/06104430_V9Tz.png "每个程序员都应该了解的内存知识")
...
[![每个程序员都应该了解的内存知识]({{ site.assetpath }}/2013-03/06104431_mINo.png "每个程序员都应该了解的内存知识")]({{ site.assetpath }}/2013-03/06104431_mINo.png "每个程序员都应该了解的内存知识")
...
[![]({{ site.assetpath }}/2013-03/06104431_ys3P.png "每个程序员都应该了解的内存知识")]({{ site.assetpath }}/2013-03/06104431_ys3P.png "每个程序员都应该了解的内存知识")
...
[![每个程序员都应该了解的内存知识]({{ site.assetpath }}/2013-03/06104431_i8Of.png "每个程序员都应该了解的内存知识")]({{ site.assetpath }}/2013-03/06104431_i8Of.png "每个程序员都应该了解的内存知识")
...
[![每个程序员都应该了解的内存知识]({{ site.assetpath }}/2013-03/06104432_i34C.png "每个程序员都应该了解的内存知识")]({{ site.assetpath }}/2013-03/06104432_i34C.png "每个程序员都应该了解的内存知识")

　　这就意味着需要一些时间（时间长短取决于电容C和电阻R）来对电容进行冲放电。另一个负面作用是，信号放大器的输出电流不能立即就作为信号载体使用。图2.6显示了冲放电的曲线，x轴表示的是单位时间下的R*C[![每个程序员都应该了解的内存知识]({{ site.assetpath }}/2013-03/06104432_ePJr.png "每个程序员都应该了解的内存知识")]({{ site.assetpath }}/2013-03/06104432_ePJr.png "每个程序员都应该了解的内存知识")
...
[![每个程序员都应该了解的内存知识]({{ site.assetpath }}/2013-03/06104432_tXPs.png "每个程序员都应该了解的内存知识")]({{ site.assetpath }}/2013-03/06104432_tXPs.png "每个程序员都应该了解的内存知识")
...
[![每个程序员都应该了解的内存知识]({{ site.assetpath }}/2013-03/06104432_0ZDH.png "每个程序员都应该了解的内存知识")]({{ site.assetpath }}/2013-03/06104432_0ZDH.png "每个程序员都应该了解的内存知识")
...
![每个程序员都应该了解的内存知识]({{ site.assetpath }}/2013-03/06104433_y5nt.png "每个程序员都应该了解的内存知识")
...
[![每个程序员都应该了解的内存知识]({{ site.assetpath }}/2013-03/06104433_JWAj.png "每个程序员都应该了解的内存知识")]({{ site.assetpath }}/2013-03/06104433_JWAj.png "每个程序员都应该了解的内存知识")
...
[![]({{ site.assetpath }}/2013-03/06104433_A6Jf.png "每个程序员都应该了解的内存知识")]({{ site.assetpath }}/2013-03/06104433_A6Jf.png "每个程序员都应该了解的内存知识")
...
![每个程序员都应该了解的内存知识]({{ site.assetpath }}/2013-03/06104433_pulx.png "每个程序员都应该了解的内存知识")
...
[![每个程序员都应该了解的内存知识]({{ site.assetpath }}/2013-03/06104433_dVKN.png "每个程序员都应该了解的内存知识")]({{ site.assetpath }}/2013-03/06104433_dVKN.png "每个程序员都应该了解的内存知识")
