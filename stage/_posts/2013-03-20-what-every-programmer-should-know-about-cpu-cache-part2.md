...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/120.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/120.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/214.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/214.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/38.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/38.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/46.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/46.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/56.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/56.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/65.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/65.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/74.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/74.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/82.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/82.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/92.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/92.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/103.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/103.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/1110.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/1110.png "每个程序员都应该了解的 CPU 高速缓存")
<center>图 3.10: 顺序读访问, NPAD=0</center>

[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/122.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/122.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/132.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/132.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU高速缓存]({{ site.assetpath }}/2013-03/142.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/142.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/152.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/152.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/162.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/162.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/172.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/172.png "每个程序员都应该了解的 CPU 高速缓存")
<center>图3.16: L2d未命中率</center>

　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/182.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/182.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/192.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/192.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/202.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/202.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/215.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/215.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/222.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/222.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/232.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/232.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/latex-math-1.gif "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/latex-math-1.gif "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/241.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/241.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/251.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/251.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/261.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/261.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/271.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/271.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/281.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/281.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/291.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/291.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/30.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/30.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/311.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/311.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/321.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/321.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存]({{ site.assetpath }}/2013-03/331.png "每个程序员都应该了解的 CPU 高速缓存")]({{ site.assetpath }}/2013-03/331.png "每个程序员都应该了解的 CPU 高速缓存")
